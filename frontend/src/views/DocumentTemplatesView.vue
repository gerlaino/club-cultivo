...
.dtv__title  { font-size: 1.5rem; font-weight: 700; color: var(--c-slate-900); margin: 0; }
.dtv__sub    { font-size: .82rem; color: var(--c-slate-500); margin: .15rem 0 0; }
...
.dtv__btn-ghost { background: #fff; border: 1.5px solid var(--c-slate-200); color: var(--c-slate-500); padding: .55rem 1rem; border-radius: 9px; font-size: .875rem; font-weight: 500; cursor: pointer; }
.dtv__btn-ghost:hover:not(:disabled) { background: var(--c-slate-50); }
...
.dtv__pill  { background: none; border: 1.5px solid var(--c-slate-200); color: #6b7280; padding: .35rem .75rem; border-radius: 99px; font-size: .78rem; font-weight: 500; cursor: pointer; transition: all .15s; white-space: nowrap; }
.dtv__pill:hover { border-color: var(--c-slate-400); color: #1e293b; }
...
/* Empty */
.dtv__empty      { text-align: center; padding: 3rem 1rem; color: var(--c-slate-500); }
.dtv__empty-icon { font-size: 2.5rem; margin-bottom: .75rem; }
.dtv__empty-title { font-size: 1rem; font-weight: 700; color: var(--c-slate-900); margin: 0 0 .4rem; }
...
/* Template card */
.template-card { background: #fff; border-radius: 14px; border: 1.5px solid var(--c-slate-200); overflow: hidden; display: flex; flex-direction: column; transition: all .15s; }
...
.template-card__badge--inactive { background: var(--c-slate-100); color: var(--c-slate-500); border: 1px solid var(--c-slate-200); }
.template-card__name { font-size: .9rem; font-weight: 700; color: var(--c-slate-900); margin: 0 0 .3rem; }
.template-card__desc { font-size: .78rem; color: var(--c-slate-500); margin: 0 0 .5rem; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; flex: 1; }
.template-card__flags { display: flex; flex-wrap: wrap; gap: .3rem .75rem; font-size: .75rem; color: var(--c-slate-500); margin-bottom: .75rem; }
.template-card__flags i { margin-right: .2rem; }
.template-card__actions { display: flex; gap: .5rem; padding-top: .75rem; border-top: 1px solid var(--c-slate-100); margin-top: auto; }
...
.dtv-modal__title  { font-size: 1rem; font-weight: 700; color: var(--c-slate-900); margin: 0; }
.dtv-modal__close  { background: none; border: none; cursor: pointer; color: var(--c-slate-400); font-size: 1rem; padding: .2rem; border-radius: 6px; transition: all .15s; }
.dtv-modal__close:hover { background: var(--c-slate-100); color: var(--c-slate-600); }
...
.dtv-form__input  { padding: .5rem .7rem; border: 1.5px solid var(--c-slate-200); border-radius: 8px; font-size: .875rem; color: #1e293b; background: #fff; outline: none; transition: border-color .15s; width: 100%; box-sizing: border-box; }
...
.dtv-form__toggle-track { width: 36px; height: 20px; border-radius: 10px; background: var(--c-slate-200); position: relative; transition: background .2s; flex-shrink: 0; }
...
.dtv-vars__pill { background: none; border: 1px solid var(--c-slate-200); color: var(--c-slate-600); padding: .15rem .45rem; border-radius: 5px; font-size: .72rem; font-family: monospace; cursor: pointer; transition: all .15s; }
.dtv-vars__pill:hover { background: var(--c-slate-50); border-color: #1a3d2e; color: #1a3d2e; }
</style>
