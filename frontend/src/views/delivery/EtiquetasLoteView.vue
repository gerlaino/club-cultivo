...
<style scoped>
.etl { min-height: 100vh; background: var(--c-slate-100); }
...
.etl__btn-back { font-size: .85rem; color: var(--c-slate-500); background: none; border: none; cursor: pointer; padding: .3rem .6rem; border-radius: 6px; }
.etl__btn-back:hover { background: var(--c-slate-50); color: var(--c-slate-700); }
...
.etl__select { padding: .4rem .6rem; border: 1px solid var(--c-slate-300); border-radius: 6px; font-size: .85rem; }
.etl__btn-ghost { padding: .5rem .8rem; background: #fff; color: var(--c-slate-700); border: 1.5px solid var(--c-slate-300); border-radius: 7px; font-size: .82rem; font-weight: 600; cursor: pointer; }
.etl__btn-ghost:hover:not(:disabled) { background: var(--c-slate-50); }
...
.etl__loading { padding: 3rem; text-align: center; color: var(--c-slate-500); }
