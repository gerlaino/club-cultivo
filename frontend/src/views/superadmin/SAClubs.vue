...
.sac__list-header { display: grid; grid-template-columns: 2fr 1.5fr 1fr 1fr 100px 40px; padding: .65rem 1.1rem; font-size: .7rem; font-weight: 700; text-transform: uppercase; letter-spacing: .05em; color: var(--c-slate-400); border-bottom: 1px solid var(--c-slate-100); background: #fafbfc; }
.sac__row { display: grid; grid-template-columns: 2fr 1.5fr 1fr 1fr 100px 40px; align-items: center; padding: .875rem 1.1rem; border-bottom: 1px solid var(--c-slate-50); text-decoration: none; color: inherit; transition: background .12s; }
...
.sac__metrica { display: inline-flex; align-items: center; gap: .25rem; font-size: .75rem; color: var(--c-slate-500); }

.sac__date { font-size: .75rem; color: var(--c-slate-400); }
