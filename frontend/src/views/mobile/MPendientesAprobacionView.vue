...
.mpa__title { font-size: 1.15rem; font-weight: 800; color: #0f172a; margin: 0; }
.mpa__loading { display: flex; align-items: center; gap: .5rem; justify-content: center; padding: 2.5rem; color: #94a3b8; font-size: .875rem; }
.mpa__spin { animation: spin .8s linear infinite; }
@keyframes spin { to { transform: rotate(360deg); } }
.mpa__empty { display: flex; flex-direction: column; align-items: center; gap: .4rem; padding: 3rem 1rem; color: #94a3b8; font-size: .875rem; text-align: center; }
.mpa__empty-icon { font-size: 2.5rem; color: #22c55e; }
.mpa__empty-sub { font-size: .75rem; color: #94a3b8; }
...
.mpa__codigo { font-size: .95rem; font-weight: 800; color: #0f172a; font-family: monospace; }
.mpa__badge { font-size: .62rem; font-weight: 700; padding: .2em .55em; border-radius: 999px; background: #fef3c7; color: #b45309; }
.mpa__card-meta { font-size: .72rem; color: #64748b; display: flex; align-items: center; gap: .3rem; }
