...
.en__head h1 { font-size: var(--fs-22, 22px); font-weight: 700; color: var(--c-slate-900); margin: 0; }
.en__loading, .en__empty { color: var(--c-slate-500); padding: var(--sp-8, 32px); text-align: center; }

.tbl { width: 100%; border-collapse: collapse; font-size: var(--fs-14, 14px); background: var(--c-paper, #fff); border: 1px solid var(--c-slate-100); border-radius: var(--r-md, 10px); overflow: hidden; }
.tbl th { text-align: left; font-size: var(--fs-11, 11px); text-transform: uppercase; letter-spacing: .05em; color: var(--c-slate-400); font-weight: 700; padding: 10px 12px; border-bottom: 1px solid var(--c-slate-100); }
.tbl td { padding: 10px 12px; border-bottom: 1px solid var(--c-slate-100); color: #1e293b; }
.tbl tr:last-child td { border-bottom: none; }
.cod { display: block; font-family: inherit; font-size: var(--fs-11, 11px); color: var(--c-slate-400); }
...
.st.used { background: var(--c-slate-100); color: var(--c-slate-500); }
.st.bad { background: #fee2e2; color: #dc2626; }
.lnk { background: none; border: none; color: var(--c-slate-500); font-size: var(--fs-13, 13px); cursor: pointer; padding: 2px 6px; }
...
.modal h3 { margin: 0; font-size: var(--fs-18, 18px); color: var(--c-slate-900); }
.modal__hint { color: var(--c-slate-500); font-size: var(--fs-13, 13px); margin: 4px 0 var(--sp-3, 12px); }
.qrimg { width: 220px; height: 220px; border-radius: var(--r-md, 10px); }
.cod2 { font-family: inherit; font-size: var(--fs-12, 12px); color: var(--c-slate-400); margin: 8px 0 var(--sp-3, 12px); }
.modal__actions { display: flex; gap: 8px; justify-content: center; }
.btn { border: 1px solid var(--c-slate-200); background: var(--c-paper, #fff); color: #1e293b; border-radius: var(--r-sm, 8px); padding: 8px 16px; font-size: var(--fs-13, 13px); font-weight: 600; cursor: pointer; }
