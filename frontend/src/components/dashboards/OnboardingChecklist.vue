...
const CHECKLISTS = {
  admin: [
    {
      ...
      pasos: [
        ...
        'Completá nombre, dirección, CUIT y número REPROCANN asignado por el ANMAT.',
        'Guardá — ya aparece activa en tu dashboard.',
      ],
      tip: 'El número REPROCANN es el que emite el ANMAT. Lo vas a necesitar para el Informe Semestral.',
      ruta: '/sedes',
    ...
    },
    {
      ...
      pasos: [
        ...
        'Desde la ficha del socio podés agregar documentos y notas clínicas.',
      ],
      tip: 'El sistema avisa 30 días antes de que venza el REPROCANN de cualquier socio — sin seguimiento manual de tu parte.',
      ruta: '/pacientes/nuevo',
      rutaLabel: 'Nuevo socio',
    },
    {
      id: 'contabilidad',
      emoji: '📊',
    ...
    },
    {
      ...
      descripcion: 'El informe que el club presenta ante el ANMAT cada 6 meses.',
      pasos: [
        'Andá a Informe Semestral en el menú lateral.',
        'Seleccioná el período (semestre 1 o 2) y el año.',
        'Revisá el preview — el sistema detecta datos faltantes que podría observar el ANMAT.',
  ...
  cultivador: [
    ...
    },
    {
      ...
      descripcion: 'Un lote es un grupo de plantas de la misma genética en el mismo ciclo.',
      pasos: [
      ...
      tip: 'Si cultivás varias cepas en la misma sala, creá un lote separado por cada una. Así el rendimiento queda trazado por genética.',
      ruta: '/lotes',
    ...
    },
    {
      ...
      descripcion: 'Cuando el lote esté listo, pasalo a la siguiente etapa del ciclo.',
      pasos: [
        'Entrá al lote desde la vista de Lotes.',
        'Hacé clic en "Avanzar fase".',
        'Confirmá el cambio — queda registrado con fecha y hora.',
        'Ciclo completo: Vegetativo → Floración → Cosecha → Secado → Manicura → Curado → Finalizado.',
      ],
      tip: 'Cada transición queda en el historial del lote y alimenta la analítica de ciclos: días promedio por fase y por cepa.',
      ruta: '/lotes',
  ...
  dispensador: [
    ...
    },
    {
      ...
      descripcion: 'Buscá al socio, elegí producto y cantidad, y confirmá.',
      pasos: [
        'Hacé clic en "Nueva dispensación" en el header del dashboard.',
        'Buscá al socio por nombre o DNI.',
    ...
    },
    {
      ...
      pasos: [
        ...
        'Aparece cada dispensación del día con hora, socio, producto y cantidad.',
  ...
  medico: [
    {
      ...
      descripcion: 'Socios con seguimiento médico activo y estado de sus autorizaciones.',
      pasos: [
        'Andá a Pacientes en el menú lateral.',
        'Ves los socios que tienen seguimiento médico activo.',
    ...
    },
    {
      ...
      tip: 'El ANMAT requiere REPROCANN vigente para cada dispensación. Un socio con autorización vencida no debería recibir producto.',
      ruta: '/medico/pacientes',
  ...
  auditor: [
    ...
    },
    {
      ...
      descripcion: 'Estado de habilitaciones médicas de todos los socios.',
      pasos: [
        'Andá a REPROCANN en el menú lateral.',
        'Ves el estado de cada socio: vigente, por vencer o vencido.',
        'El informe incluye nombre, DNI y fecha de vencimiento de cada autorización.',
        'Podés exportar el informe completo a PDF.',
      ],
      tip: 'Este informe verifica que cada socio que recibió producto tenía su autorización vigente al momento de la dispensación.',
    ...
    },
    {
      ...
      descripcion: 'Lotes, rendimiento y entrega de producto a socios.',
      pasos: [
        ...
        'Cada dispensación tiene fecha, socio, producto, cantidad y operador.',
        'Podés filtrar por período y exportar a CSV.',
      ],
      tip: 'La trazabilidad cierra cuando podés seguir cada gramo: desde qué lote salió, en qué stock quedó, y a qué socio se entregó.',
    ...
    },
    {
      ...
      pasos: [
        ...
        'Buscá por lote, socio, fecha o tipo de evento.',
      ...
      tip: 'La trazabilidad es tu aliada ante el ANMAT. Cuanto más completa es la carga de datos del club, más sólido es el registro.',
