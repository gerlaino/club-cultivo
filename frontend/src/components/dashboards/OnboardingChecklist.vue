  ...
  admin: [
    {
      ...
      descripcion: 'Nombre, dirección, CUIT y número REPROCANN de la organización.',
      pasos: [
        'Andá a Sedes en el menú lateral izquierdo.',
        'Hacé clic en "Nueva sede".',
        'Completá nombre, dirección, CUIT y el número REPROCANN de la organización.',
    ...
    },
    {
      ...
      pasos: [
        ...
        'Repetí por cada espacio activo de la organización.',
      ],
    ...
    },
    {
      ...
      descripcion: 'El informe que la organización presenta ante la autoridad sanitaria cada 6 meses.',
      pasos: [
  ...
  auditor: [
    {
      ...
      descripcion: 'Vista de solo lectura de todos los módulos de la organización.',
      pasos: [
        'Desde tu dashboard tenés acceso directo a todos los informes.',
        'Tu rol es de solo lectura — no podés modificar ningún dato.',
        'Cada sección muestra datos en tiempo real de la organización.',
      ],
      tip: 'Si encontrás inconsistencias, coordinalas con el admin de la organización. No podés editar datos desde este rol.',
    },
    {
      id: 'reprocann',
      emoji: '📋',
    ...
    },
    {
      ...
      descripcion: 'Historial íntegro de cada movimiento de la organización.',
      pasos: [
      ...
      tip: 'La trazabilidad es tu aliada ante cualquier control. Cuanto más completa es la carga de datos de la organización, más sólido es el registro.',
