...
const CHECKLISTS = {
  ...
  cultivador: [
    ...
    },
    {
      ...
      descripcion: 'Un lote es un grupo de plantas de la misma genética en la misma fase.',
      pasos: [
    ...
    },
    {
      ...
      pasos: [
        ...
        'Fase completa: Vegetativo → Floración → Cosecha → Secado → Manicura → Curado → Finalizado.',
      ],
      tip: 'Cada transición queda en el historial del lote y alimenta la analítica de fases: días promedio por fase y por genética.',
      ruta: '/lotes',
