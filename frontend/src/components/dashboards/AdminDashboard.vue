...
const alertas = computed(() => {
  ...
  if (v > 0) {
    list.push({
      ...
      msg: `${v} paciente${v !== 1 ? 's' : ''} con REPROCANN vencido`,
      action: { label: 'Ver pacientes', to: '/socios' }
    })
  }
  ...
  if (tv > 0) {
    list.push({
      ...
      msg: `${tv} tarea${tv !== 1 ? 's' : ''} vencida${tv !== 1 ? 's' : ''} sin completar`,
      action: { label: 'Ver tareas', to: '/tareas' }
    })
  }
  return list
})
    ...
    <template v-else>
      ...
      <div v-if="alertas.length" class="ad__alertas">
        <div
          ...
          :key="i"
          class="ad__alerta"
          :class="`ad__alerta--${a.level}`"
        >
          <i :class="['bi', a.icon, 'ad__alerta-icon']"></i>
          <span class="ad__alerta-msg">{{ a.msg }}</span>
          <RouterLink :to="a.action.to" class="ad__alerta-action">
            {{ a.action.label }} →
          </RouterLink>
        </div>
      </div>
      ...
      <div class="ad__kpis">
        ...
        <RouterLink to="/salas" class="ad__kpi ad__kpi--link">
          <div class="ad__kpi-icon" style="background:rgba(21,128,61,.1);color:#15803d">
        ...
        <RouterLink to="/socios" class="ad__kpi ad__kpi--link">
          <div class="ad__kpi-icon" style="background:rgba(3,105,161,.1);color:#0369a1">
          ...
          <div v-if="stats.vencimientos" class="ad__kpi-sub" style="color:#b45309">
            {{ stats.vencimientos }} REPROCANN por vencer
          </div>
        </RouterLink>

        <RouterLink to="/salas" class="ad__kpi ad__kpi--link">
          <div class="ad__kpi-icon" style="background:rgba(124,58,237,.1);color:#7c3aed">
        ...
        <RouterLink to="/contabilidad" class="ad__kpi ad__kpi--link"
                    :class="(contable?.mes_actual?.balance || 0) >= 0 ? 'ad__kpi--ok' : 'ad__kpi--danger'">
          <div class="ad__kpi-icon"
          ...
          <div class="ad__kpi-body">
            <div class="ad__kpi-val" :style="(contable?.mes_actual?.balance || 0) >= 0 ? 'color:#15803d' : 'color:#dc2626'">
              {{ fmtCompacto(contable?.mes_actual?.balance || 0) }}
            </div>
        ...
        <RouterLink to="/tareas" class="ad__kpi ad__kpi--link"
                    :class="(tareas?.stats?.vencidas || 0) > 0 ? 'ad__kpi--danger' : (tareas?.stats?.pendientes || 0) > 0 ? 'ad__kpi--warn' : ''">
          <div class="ad__kpi-icon"
               :style="(tareas?.stats?.vencidas || 0) > 0 ? 'background:rgba(220,38,38,.1);color:#dc2626' : 'background:rgba(180,83,9,.1);color:#b45309'">
          ...
          <div class="ad__kpi-sub">
            <span v-if="tareas?.stats?.vencidas" style="color:#dc2626">
              {{ tareas.stats.vencidas }} vencida{{ tareas.stats.vencidas !== 1 ? 's' : '' }}
            </span>
        ...
        <RouterLink to="/usuarios" class="ad__kpi ad__kpi--link">
          <div class="ad__kpi-icon" style="background:rgba(15,23,42,.06);color:#475569">
      ...
      <div class="ad__layout">
        ...
        <!-- Columna izquierda — Sedes + gráfico -->
        <div class="ad__col ad__col--main">
          ...
          <div class="ad__card">
            <div class="ad__card-header">
              <div class="ad__card-title-wrap">
                <span class="ad__card-icon" style="background:rgba(27,94,32,.1);color:#1b5e20">
            ...
            <div v-if="!sedes.length" class="ad__empty">
              ...
              <RouterLink to="/sedes" class="ad__btn-sm-green">Crear primera sede</RouterLink>
            </div>
            ...
            <div v-else class="ad__sedes">
              ...
              >
                ...
                <div class="ad__sede-reprocann" v-if="sede.declarada_reprocann">
          ...
          <div class="ad__card ad__card--mt" v-if="stats.vegetativo || stats.floracion">
            <div class="ad__card-header">
              <div class="ad__card-title-wrap">
                <span class="ad__card-icon" style="background:rgba(21,128,61,.1);color:#15803d">
                  <i class="bi bi-pie-chart"></i>
                </span>
                <span class="ad__card-title">Distribución del cultivo</span>
              </div>
            </div>
            <div class="ad__card-body">
        ...
        <!-- Columna derecha — Tareas + Acciones + Contabilidad -->
        <div class="ad__col ad__col--side">
          ...
          <div class="ad__card">
            <div class="ad__card-header">
              <div class="ad__card-title-wrap">
                <span class="ad__card-icon" style="background:rgba(15,23,42,.06);color:#0f172a">
            ...
            <div class="ad__actions">
              <RouterLink to="/socios/nuevo" class="ad__action">
                <div class="ad__action-icon" style="background:rgba(3,105,161,.08);color:#0369a1">
                  <i class="bi bi-person-plus"></i>
                </div>
              ...
              <RouterLink to="/contabilidad" class="ad__action">
                <div class="ad__action-icon" style="background:rgba(21,128,61,.08);color:#15803d">
              ...
              <RouterLink to="/tareas" class="ad__action">
                <div class="ad__action-icon" style="background:rgba(124,58,237,.08);color:#7c3aed">
              ...
              <RouterLink to="/informe-semestral" class="ad__action">
                <div class="ad__action-icon" style="background:rgba(180,83,9,.08);color:#b45309">
          ...
          <div class="ad__card ad__card--mt" v-if="tareasUrgentes.length">
            <div class="ad__card-header">
              <div class="ad__card-title-wrap">
                <span class="ad__card-icon" style="background:rgba(180,83,9,.1);color:#b45309">
            ...
            <div class="ad__tareas">
              <RouterLink
                ...
                class="ad__tarea"
              >
                <div class="ad__tarea-prio"
                     :style="{ background: prioMeta(t.prioridad).bg, color: prioMeta(t.prioridad).color }">
                ...
                <div class="ad__tarea-body">
                  ...
                  <div class="ad__tarea-meta">
                    ...
                    <span v-if="t.fecha_programada" :style="new Date(t.fecha_programada) < new Date() ? 'color:#dc2626;font-weight:600' : ''">
          ...
          <div class="ad__card ad__card--mt" v-if="contable?.ultimos_movimientos?.length">
            <div class="ad__card-header">
              <div class="ad__card-title-wrap">
                <span class="ad__card-icon" style="background:rgba(3,105,161,.1);color:#0369a1">
...
.ad__eyebrow {
  ...
  color: var(--brand-accent, #66bb6a); margin-bottom: .35rem;
}
.ad__eyebrow-dot {
...
.ad__btn-ghost {
  ...
  font-size: 1rem; cursor: pointer; text-decoration: none; transition: all .15s;
}
