...
import { Home, Users, History, Boxes, BookmarkCheck, Beer, ListChecks, Clock, Store } from 'lucide-vue-next'

const club = useClubStore()

const BASE_LINKS = [
  { to: '/',          icon: Home,          label: 'Inicio' },
  // Arriba de todo a propósito: para quien sólo dispensa, es la pantalla del día.
  ...
  { to: '/stock',     icon: Boxes,         label: 'Depósito' },
