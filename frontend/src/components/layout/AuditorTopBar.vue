...
const LABELS = { '/auditor': 'Inicio', '/auditor/reprocann': 'Informe REPROCANN', '/auditor/produccion': 'Informe Producción', '/auditor/dispensaciones': 'Informe Dispensaciones' }
