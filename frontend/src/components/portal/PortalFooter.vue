  ...
  <footer class="footer">
    <div class="footer__inner">
      ...
      <div class="footer__col">
        ...
        <RouterLink to="/portal/geneticas" class="footer__link">Variedades</RouterLink>
        <RouterLink to="/portal/noticias" class="footer__link">Noticias</RouterLink>
        <RouterLink to="/portal/eventos" class="footer__link">Eventos</RouterLink>
        <RouterLink to="/portal/galeria" class="footer__link">Galería</RouterLink>
        <RouterLink to="/portal/contacto" class="footer__link">Contacto</RouterLink>
      </div>
