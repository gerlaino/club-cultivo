<template>
  <Teleport to="body">
    <div v-modal="() => $emit('update:modelValue', false)" v-if="modelValue" class="rls__overlay">
...
import AmbientalForm from '../lotes/registro/AmbientalForm.vue'
import LuzForm      from '../lotes/registro/LuzForm.vue'
import LimpiezaForm from '../lotes/registro/LimpiezaForm.vue'
...
.rls__accion-card:hover { border-color: var(--brand-primary); background: var(--c-leaf-50); }
