...
/* Card */
.sc__card { background: #fff; border: 1px solid #e2e8f0; border-radius: 14px; overflow: hidden; margin-bottom: 1rem; }
...
.sc__to-name { font-weight: 600; color: #0f172a; }
.sc__to-email { color: #64748b; }
...
.sc__charcount { font-size: .7rem; color: #94a3b8; text-align: right; margin-top: .2rem; }

.sc__preview {
  background: #f8fafc; border: 1.5px solid #e2e8f0; border-radius: 8px;
  padding: 1.25rem 1rem; min-height: 180px;
}
.sc__preview-subject { font-weight: 700; color: #0f172a; font-size: .95rem; margin-bottom: .75rem; border-bottom: 1px solid #e2e8f0; padding-bottom: .6rem; }
.sc__preview-body { font-size: .875rem; color: #334155; line-height: 1.7; white-space: pre-wrap; }
...
.sc__history-title { font-size: .72rem; font-weight: 700; text-transform: uppercase; letter-spacing: .06em; color: #94a3b8; margin-bottom: .75rem; }
.sc__loading { display: flex; justify-content: center; padding: 2rem; }
.sc__empty { text-align: center; padding: 1.5rem 1rem; color: #94a3b8; }
.sc__empty-ico { display: flex; justify-content: center; margin-bottom: .5rem; opacity: .4; }
.sc__empty-title { font-size: .875rem; font-weight: 600; color: #64748b; }
...
.sc__item { display: flex; align-items: flex-start; gap: .75rem; padding: .875rem 1rem; border-bottom: 1px solid #f1f5f9; }
...
.sc__item-subject { font-size: .875rem; font-weight: 600; color: #0f172a; margin-bottom: .15rem; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.sc__item-meta { font-size: .75rem; color: #94a3b8; }
.sc__item-tipo { flex-shrink: 0; }
.sc__tipo-badge { font-size: .7rem; font-weight: 600; background: #f1f5f9; color: #475569; padding: .15rem .5rem; border-radius: 5px; }
</style>
