...
.mre__head { display: flex; align-items: center; justify-content: space-between; padding: 1rem 1.25rem; border-bottom: 1px solid var(--c-slate-100); }
.mre__head h3 { font-size: 1rem; font-weight: 800; margin: 0; color: var(--c-slate-900); }
.mre__close { background: var(--c-slate-100); border: none; width: 28px; height: 28px; border-radius: 7px; cursor: pointer; color: var(--c-slate-500); }
...
.mre__input { background: var(--c-slate-50); border: 1.5px solid var(--c-slate-200); border-radius: 9px; padding: .55rem .8rem; font-size: .85rem; color: var(--c-slate-900); width: 100%; box-sizing: border-box; outline: none; }
.mre__foot { display: flex; justify-content: flex-end; gap: .6rem; padding: .85rem 1.25rem; border-top: 1px solid var(--c-slate-100); }
...
.mre__btn-ghost { background: #fff; color: var(--c-slate-500); border: 1.5px solid var(--c-slate-200); padding: .55rem 1.1rem; border-radius: 9px; font-size: .85rem; font-weight: 600; cursor: pointer; }
</style>
