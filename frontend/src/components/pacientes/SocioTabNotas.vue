...
<style scoped>
.stn__card { background: #fff; border: 1px solid var(--c-slate-200); border-radius: 14px; overflow: hidden; }
.stn__header { display: flex; align-items: flex-start; gap: .65rem; padding: 1rem 1.25rem; border-bottom: 1px solid var(--c-slate-100); background: #fafbfc; }
...
.stn__title { font-size: .875rem; font-weight: 700; color: var(--c-slate-900); margin-top: .15rem; }
.stn__subtitle { font-size: .72rem; color: var(--c-slate-500); margin-top: .1rem; }
.stn__nota-form { padding: 1.25rem; border-bottom: 1px solid var(--c-slate-100); }
.stn__textarea { width: 100%; background: var(--c-slate-50); border: 1.5px solid var(--c-slate-200); border-radius: 10px; padding: .75rem 1rem; font-size: .875rem; color: var(--c-slate-900); outline: none; resize: vertical; min-height: 80px; transition: border-color .15s; box-sizing: border-box; font-family: inherit; }
...
.stn__char-count { font-size: .72rem; color: var(--c-slate-400); }
.stn__loading { display: flex; justify-content: center; padding: 2rem; }
.stn__empty { text-align: center; padding: 3rem 1rem; color: var(--c-slate-400); }
.stn__empty-icon { display: flex; justify-content: center; margin-bottom: .5rem; opacity: .4; }
.stn__empty-title { font-size: .875rem; font-weight: 600; color: var(--c-slate-500); }
.stn__notas { display: flex; flex-direction: column; }
.stn__nota { padding: .875rem 1.25rem; border-bottom: 1px solid var(--c-slate-50); }
...
.stn__nota-meta { font-size: .72rem; color: var(--c-slate-400); }
...
.stn__btn-danger { background: none; border: none; color: var(--c-slate-400); cursor: pointer; padding: .2rem .4rem; border-radius: 5px; display: flex; align-items: center; transition: all .12s; }
