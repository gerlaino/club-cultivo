...
// de humedad y adentro hay 90%). Va aparte de registrarSala y alcanza a todos los que enraízan.
...
export const reevaluarManicura   = (loteId)                             => api.post(`/lotes/${loteId}/reevaluar_manicura`)
...
export const deleteCategoriaProducto  = (id)          => api.delete(`/categorias_producto/${id}`)
...
export const createBarProducto  = (barId, payload, carga = null) => api.post(`/bares/${barId}/productos`, { bar_producto: payload, carga_inicial: carga || undefined })
