...
export const CICLO_BASE = ['vegetativo', 'floracion', 'cosecha', 'secado', 'curado']

export const FASE_LABELS = {
  vegetativo: 'Vegetativo', floracion: 'Floración', secado: 'Manicura',
  curado: 'Curado', cosecha: 'Cosecha', semilla: 'Germinación',
...
export const POST_HARVEST_ESTADOS = ['cosecha', 'secado', 'manicura_pendiente', 'en_manicura', 'curado', 'finalizado']
