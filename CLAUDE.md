...
Nota histórica: "Socio" y "Paciente" son el mismo concepto — el modelo es `Paciente`, la UI dice "Socios". No crear modelos/controllers nuevos con "socio".
...
6. **Dispensaciones** — carrito, medios de pago (efectivo/transferencia/cuenta corriente/no abona), validación de crédito, CSV. (`limite_dispensacion_mensual_g` existe en el schema pero **no es una feature en uso** — ver Dominio.)
...
| `supervisor` | Lectura de cultivo + gestión de tareas |
| `manicura` | Post-cosecha: pesajes, inventario, salas kind=manicura |
| `dispensador` | Dispensaciones, stock por sede, socios (lectura) |
...
*Última actualización: 2026-06-12. Mantener actualizado: cuando se cierre un bloque de trabajo, actualizar "Módulos existentes" acá y `docs/CHANGELOG.md`.*
