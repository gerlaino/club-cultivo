module Mostradores
  ...
  #   · corregido    → quien abrió corrigió lo que decía la mesa
  ...
  class MotivosDeRevision
    RAZONES = %w[faltante corregido mesa_movida].freeze
    ...
    def self.por_turno(candidatos)
      ...
      (con_faltante | corregidos | mesa_movida).index_with do |id|
        [
