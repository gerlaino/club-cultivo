module Finanzas
  ...
  class SembrarCatalogo
    ...
    # LO ÚNICO PREDETERMINADO SON LOS SECTORES, con su depósito. Las CATEGORÍAS las crea el
    # admin de cada organización: nombre, tipo y sector.
    #
    # Se habían sembrado (Fertilizante, Sueldos, Alquiler…) para que el primer gasto no se
    # cargara contra un combo vacío. En la práctica cada organización gasta en cosas distintas,
    # y una lista ajena que además no se puede borrar —son `es_sistema`— es peor que una vacía:
