...
# justamente el que lista qué falta declarar: bloquearlo dejaría al club sin poder ver su
...
module DeclaracionInaseGuard
  ...
  # Las genéticas del club que no están inscriptas ni declaradas. nil si está todo en orden.
  ...
  def bloquear_descarga_si_falta_declarar!
    ...
    render json: {
      error: 'No se puede descargar el informe: hay variedades que el club no puede acreditar ' \
