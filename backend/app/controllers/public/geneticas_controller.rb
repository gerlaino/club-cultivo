module Public
  class GeneticasController < BaseController
    ...
    # GET /p/:club_slug/geneticas/:slug  (slug de genética)
    def show
      genetica = current_club.geneticas.visibles_web.find_by(slug: params[:id]) ||
                 current_club.geneticas.visibles_web.find_by(id: params[:id])
