...
ActiveRecord::Schema[7.2].define(version: 2026_09_18_150000) do
  ...
  create_table "bar_productos", force: :cascade do |t|
    ...
    t.boolean "vendible", default: true, null: false
  ...
  create_table "compras_cuotas", force: :cascade do |t|
    ...
    t.index ["categoria_contable_id"], name: "index_compras_cuotas_on_categoria_contable_id"
  ...
  create_table "lotes", force: :cascade do |t|
    ...
    t.string "light_type"
    t.string "estado"
    t.decimal "tamanio_maceta", precision: 6, scale: 3
    ...
    t.decimal "tamanio_maceta_inicial", precision: 6, scale: 3
  ...
  create_table "stock_movimientos", force: :cascade do |t|
    ...
    t.index ["fecha"], name: "index_stock_movimientos_on_fecha"
  ...
  add_foreign_key "compras_cuotas", "categorias_contables", column: "categoria_contable_id"
